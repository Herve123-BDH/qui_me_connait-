...
export const PlayAmitier = () => {
    const Question=[
        ...
        },
        {
            ...
            url: ["https://media-be.chewy.com/wp-content/uploads/2021/05/27135654/Shiba-Inu_FeaturedImage.jpg","https://cdn.futura-sciences.com/buildsv6/images/mediumoriginal/4/2/c/42c15179b9_50148966_animal-non-domestique.jpg", "https://depuismonhamac.jardiland.com/wp-content/uploads/2017/08/renard.jpg", "https://lemagdesanimaux.ouest-france.fr/images/dossiers/categories/animaux-sauvages-162902-650-400.jpg"]
        },
        {
...
//modifier les styles quand l'utilisateur clique sur une reponse photo
    ...
    const begin =()=>{
        if(user===""){
            ...
            axios.get(`http://localhost:5000/user/get/amitier/${id}`)
                    .then(response=>{
        ...
        <div className="amr">
            ...
            <div>
                ...
                {cool==Question.length-1?<Link to='/dashboard/welldone'><img style={{cursor: "pointer", width: "120px"}} onClick={()=>{
                    console.log(pro)
                    axios.post(`http://localhost:5000/user/amitier/${id}`,{friendAmitier:{name: user, score: pro}})
                    .then(data=>data)
