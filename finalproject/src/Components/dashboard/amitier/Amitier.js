...
export const Amitier = () => {
    ...
    const Question=[
        ...
        },
        {
            ...
            url: ["https://lh3.googleusercontent.com/proxy/B9I-ERBRfI05ti3bIglSfiVk5WHgrlFuoPjyuC8bNxlFEdjGkXkvOGhFo_hE276RNN1ZmE5kAmg3zipNxqYPHW7HS6bNbQpiupQdJO2UcPPUSG3dcx0fy7Dw2hGyxL_8twyiSpluC1873_3NrWkisuAt-wT0q0y1xQ","https://cdn.futura-sciences.com/buildsv6/images/mediumoriginal/4/2/c/42c15179b9_50148966_animal-non-domestique.jpg", "https://depuismonhamac.jardiland.com/wp-content/uploads/2017/08/renard.jpg", "https://lemagdesanimaux.ouest-france.fr/images/dossiers/categories/animaux-sauvages-162902-650-400.jpg"]
        },
        {
        ...
        <div className="amraaa">
            {
                ...
                {cool==Question.length-1?<Link to='/dashboard/jeucree-amitier'><img  style={{cursor: "pointer", width: "150px"}} src={Finish} onClick={()=>{
                    ...
                    axios.post(`http://localhost:5000/user/upds/${user.id}`, {responseAmitier: answers})
